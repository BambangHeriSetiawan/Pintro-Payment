 ...
 */
class AdapterPaymentGroup(private var data: List<String>, private var listener: AdapterPaymentChannel.OnAdapterPaymentChannelListener): RecyclerView.Adapter<AdapterPaymentGroup.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.binding.rcvPaymentChannel.apply {
            ...
            this.adapter = AdapterPaymentChannel(listOf("","",""), listener)
        }
    }
